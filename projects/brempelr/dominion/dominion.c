...
void adventurer_func(struct gameState *state, int currentPlayer)
{
	int drawntreasure = 0;
	int cardDrawn;
...
void smithy_func(struct gameState *state, int currentPlayer, int handPos)
{
	int i;
	for(i=0; i<2; i++)
	{
...
void village_func(struct gameState *state, int currentPlayer, int handPos)
{
	drawCard(currentPlayer, state);
...
void council_room_func(struct gameState *state, int currentPlayer, int handPos)
{
	int i;
	for(i = 0; i < 3; i++)
	{
...
int remodel_func(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2)
{
	int j;
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      adventurer_func(state, currentPlayer);
      return 0;
			
    case council_room:

      council_room_func(state, currentPlayer, handPos);
      return 0;		
    ...
    case remodel:
      j = remodel_func(state, currentPlayer, handPos, choice1, choice2);
      return j;
		
    case smithy:
      smithy_func(state, currentPlayer, handPos);
      return 0;
