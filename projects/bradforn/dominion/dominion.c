...
int cardVillage(int handPos, int currentPlayer, struct gameState *state) //+1 Card +2 Actions
{
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room: //+4 Cards +1 (Buy Each other player draws a card)
      cardCouncil_room(handPos, currentPlayer, state);
      return 0;
			
    case feast:
      cardFeast(choice1, currentPlayer, state);//gain card with cost up to 5
      return 0;
    ...
    case smithy:
      cardSmithy(handPos, currentPlayer, state); //+3 Cards
      return 0;
		
    case village:
      cardVillage(handPos, currentPlayer, state); //+1 Card +2 Actions
      return 0;
